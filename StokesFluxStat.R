...
labels <- c("B3LSB",     "B3",        "B3USB",     "B4",        "B6",        "B7",        "> B7")
colors <- c("#FF00003F", "#E020003F", "#C040003F", "#8080003F", "#00C0803F", "#0000FF3F", "#FFFFFF")
threshU <-c(97.0,        98.0,        120.0,       200.0,       280.0,       380.0,       700.0)
threshL <-c(80.0,        97.0,        98.0 ,       120.0,       200.0,       280.0,       380.0)
